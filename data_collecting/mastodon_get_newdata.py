...
def update_yesterday_data():
    ...
    query = f'text:"tariff" AND date:[{yesterday} TO {yesterday}]'
    ...
    # Traverse each URL and call the Mastodon API to obtain the detailed content
...
# === main ===
def main():
    update_yesterday_data()  # Initialize data and json_data first
